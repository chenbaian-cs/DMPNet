...
def get_test_info(config):
    ...
    elif config.sal_mode == 'test':
        image_root = 'dataset/test/test/'
        image_source = 'dataset/test/test/test.lst'
    else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--resume', action='store_true', default=False, help='Resume training the model from the last checkpoint')
    ...
    parser.add_argument('--sal_mode', type=str, default='LFSD',
                        choices=['NJU2K', 'NLPR', 'STERE', 'RGBD135', 'LFSD', 'SIP', 'SSD', 'DES', 'DUT', 'test'])  # Test image dataset
